...
const ExamplePanel = () => {
    const toggleBodyPanel = () => {
        togglePanel('body', 'content-side-open')
    };
                ...
                <Panel>
                    <div className="panel-user">
                        ...
                        <div className="panel-user-content">
                            ...
                            <div className="panel-user-action" onClick={toggleBodyPanel}>
                    ...
                    <PanelListWrapper>
                        ...
                        <PanelList>
                            ...
                            <PanelListItem>General shared terminals commands list is available <a>in
                                notes</a>.</PanelListItem>
                        </PanelList>
                    </PanelListWrapper>
                </Panel>
            </div>
