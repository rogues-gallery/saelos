...
class Detail extends React.Component {
  ...
  render() {
    switch(this.state.view) {
      case 'default':
        return <Details opportunity={this.props.opportunity} dispatch={this.props.dispatch} toggle={this._toggleView} user={this.props.user} />
      case 'history':
        return <History activities={this.props.opportunity.activities} dispatch={this.props.dispatch}  toggle={this._toggleView} />
    }
  }
}
