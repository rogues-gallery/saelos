  ...
  switch (action.type) {
    ...
    case types.FETCHING_COMPANIES_SUCCESS:
      ...
      if (meta.current_page === 1) {
        ...
        data.map(c => {
          newCompaniesForState = injectCompaniesIntoState(
            c,
            newCompaniesForState
          );
        });
      }
...
export const getCompanyIndex = (state, id) =>
  _.findIndex(getCompanies(state), c => c.id === parseInt(id));
