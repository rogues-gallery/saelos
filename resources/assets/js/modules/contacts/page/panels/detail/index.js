...
const Details = ({
  ...
  <div className={`col detail-panel border-left`}>
    <div className="border-bottom  py-2 heading">
      ...
      <div className="pt-1 mt-1 h5 text-center">Contact Details</div>
    </div>
...
const History = ({ activities, dispatch, toggle, inEdit }) => (
  <div className={`col detail-panel border-left ${inEdit ? "inEdit" : ""}`}>
    <div className="border-bottom py-2 heading">
      <a
        href="javascript:void(0)"
        className="btn btn-xs btn-outline-secondary position-fixed ml-2 mt-1"
      ...
      >
        <div className="card-body border-bottom">
          ...
          <div className="text-center mini-text text-muted text-uppercase pb-2">
            <MDIcons.MdAccessTime /> Last touched{" "}
