...
class Activity extends Model {
  ...
  initialize(props) {
    ...
    this.fulfillment_date = props.fulfillment_date
      ? moment(props.fulfillment_date)
      : moment();
    ...
    this.company =
      props.company && props.company.length
        ? new Company(props.company[0])
        : new Company({});
    this.contact =
      props.contact && props.contact.length
        ? new Contact(props.contact[0])
        : new Contact({});
    this.opportunity =
      props.company && props.opportunity.length
        ? new Opportunity(props.opportunity[0])
        : new Opportunity({});
