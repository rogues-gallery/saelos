        ...
        <div className="card-body noteActionView">
          <div className="float-right mb-2">
            <div className="mini-text font-weight-bold">
              <a href="javascript:void(0)" className={`btn btn-sm btn-link ${formState.private ? 'text-dark' : 'text-muted'}`} onClick={this._togglePrivate}>
          ...
          <div className="form-group">
            ...
            <input type="text" onChange={this._handleInputChange} value={formState.note_name} name="note_name" className="form-control" placeholder="Enter note name" />
          </div>

          <div className="form-group">
            <label htmlFor="note_content">Note</label>
            <ReactQuill name="note_content" className="fh-200" onChange={this._handleContentChange} />
          </div>
          <div className="mt-2">
            <button className="btn btn-primary mr-2" onClick={this._submit}>Save</button>
